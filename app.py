...
#     st.write(hasilRingkasan)
    ...
    message1 = st.text_area("Enter your Text", height=60, value = "Type Here", key="kalimat1")
    st.subheader("Reference")
    message2 = st.text_area("Enter your Text", height=60, value = "Type Here", key="kalimat2")
    # penilaian rouge
    hypothesis = (message1)
    reference = (message2)
    rouge = Rouge()
